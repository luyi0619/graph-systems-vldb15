...
public:
    ...
    void run_report(const WorkerParams& params, const string reportPath)
    {
        ...
        //=========================================================
        vector<long long> msgNumVec; //$$$$$$$$$$$$$$$$$$$$ added for per-worker msg counting
        ...
        while (true) {
            ...
            if (wakeAll == 1)
                ...
                active_compute();
            message_buffer->combine();
            long long my_msg_num = message_buffer->get_total_msg(); //$$$$$$$$$$$$$$$$$$$$ added for per-worker msg counting
        ...
        if (_my_rank != MASTER_RANK) {
            ...
            vector<vector<long long> > report(_num_workers);
            masterGather(report);
